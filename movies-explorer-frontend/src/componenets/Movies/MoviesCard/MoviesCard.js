...
//         <img className='card__img' src={MoviePoster} alt='Постер к фильму' />
//       </a>
//       {<button className={`${ location.pathname !== '/saved-movies' ? "card__button__save" : "card__button_remove"}`}></button>}
